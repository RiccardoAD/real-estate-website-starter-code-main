...
const PropertyModal = ({onClose, properties}) => {
 ...
 const[currentPropertyIndex, setCurrentPropertyIndexd] = useState(0);
...
const prevImage=()=>{
  ...
  return (
    ...
    backdrop-blur-md flex items-center justify-center z-50 p-4 '
     onClick={onClose}> 
     <div className='relative bg-white rounde-3xl max-w-xl w-full md:max-h-[90vh]
...
{/* Image Slider */}
   ...
   left-4 top-1/2 -translate-y-1/2 bg-white/80 p-2 rounded-full
   hover:bg-white'>
    <FaChevronLeft size = {20} />

   </button>
   <button onClick={nextImage} className='absolute
   right-4 top-1/2 -translate-y-1/2 bg-white/80 p-2 rounded-full
   hover:bg-white'>
   ...
   right-4 flex items-center gap-4">
    ...
    <button onClick={()=> setIsFavourite(!isFavourite)}
       ...
       {currentImageIndex + 1} / {images.length}
        ...
        <div className="p-6">
         ...
         <div className=" text-3xl font-bold mb-4 text-blue-600">{currentProperty.price}</div>
 ...
 <div className="flex items-center gap-2">
         ...
         <div className="mb-6">
            <h3 className='font-semibold mb-2 '> description
                </h3>
